...
La figura \ref{fig flujo2} representa los datos que fueron utilizados para realizar la integración de la información dentro de la base de datos.

\begin{figure}[H] 
	\centering
	\includegraphics[width=0.6\textwidth]{Kap3/flujo2}
	\caption{Flujo de integración de la información.} \label{fig:flujo2}
\end{figure}
