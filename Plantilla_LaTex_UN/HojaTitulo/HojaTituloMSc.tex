...
Identificación de variantes en regiones codificantes de genes en pacientes colombianos utilizando técnicas de minería de datos}\\[5.0cm]
...
\begin{center}
\thispagestyle{empty} \vspace*{0cm} \textbf{\huge
Identificación de variantes en regiones codificantes de genes en pacientes colombianos utilizando técnicas de minería de datos}\\[2.0cm]
