...
\begin{figure}[H]
	...
	\subfigure[Reglas de asociación con variantes sinonimas]{\label{fig:reglas2.1}
		\includegraphics[width=100mm]{Kap4/reglas2_1}}
	\subfigure[Reglas de asociación sin variantes sinonimas]{\label{fig:reglas2.2}
		\includegraphics[width=100mm]{Kap4/reglas2_2}}
