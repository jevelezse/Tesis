...
\begin{figure}[h!]
	...
	\subfigure[Distribucón demográfica de los pacientes]{\label{fig:grupo1}
		\includegraphics[width=60mm]{Kap4/edadc1}}
	\caption{Grupo 1}
	\label{f:grupo11}
\end{figure} 
...
\begin{figure}[H]
	...
	\subfigure[Reglas de asociacióncon variantes sinónimas.]{\label{fig:re1}
		\includegraphics[width=70mm]{Kap4/reglas1_1}}
	\subfigure[Reglas de asociación sin variantes sinónimas]{\label{fig:r1}
		\includegraphics[width=70mm]{Kap4/reglas1_2}}
...
\begin{figure}[H]
	\centering
	\subfigure[Nube de palabras]{\label{fig:nube2}\includegraphics[width=60mm]{Kap4/cluster2}}
	\subfigure[Rango de edad en décadas.]{\label{fig:demo2}\includegraphics[width=60mm]{Kap4/edadc2}}
...
\begin{figure}[H]
	...
	\subfigure[Reglas de asociación con variantes sinonimas]{\label{fig:reglas2.1}
		\includegraphics[width=70mm]{Kap4/reglas2_1}}
	\subfigure[Reglas de asociación sin variantes sinonimas]{\label{fig:reglas2_2}
		\includegraphics[width=70mm]{Kap4/reglas2_2}}
...
\begin{figure}[h]
	\centering
	\subfigure[Nube de palabras.]{\includegraphics[width=50mm]{Kap4/cluster3}}
	\subfigure[Rango de edad en décadas.]{\includegraphics[width=50mm]{Kap4/edadc3}}
...
\begin{figure}[H]
	...
	\subfigure[Reglas de asociación con variantes sinonimas]{\label{fig:r3}
		\includegraphics[width=70mm]{Kap4/reglas3_1}}
	\subfigure[Reglas de asociación sin variantes sinonimas]{\label{fig:re3}
		\includegraphics[width=70mm]{Kap4/reglas3_2}}
...
\begin{figure}[H]
	\centering
	\subfigure[Nube de palabras]{\includegraphics[width=50mm]{Kap4/cluster4}}
	\subfigure[Rango de edad en decadas]{\includegraphics[width=50mm]{Kap4/edadc4}}
...
\begin{figure}[H]
	...
	\subfigure[Reglas de asociación con variantes sinonimas]{\label{fig:r4}
		\includegraphics[width=70mm]{Kap4/reglas4_1}}
	\subfigure[Reglas de asociación sin variantes sinonimas]{\label{fig:re4}
		\includegraphics[width=70mm]{Kap4/reglas4_2}}
...
\begin{figure}[H]
	...
	\subfigure[Reglas de asociación con variantes sinonimas]{\label{fig:r5}
		\includegraphics[width=70mm]{Kap4/reglas5_1}}
	\subfigure[Reglas de asociación sin variantes sinonimas]{\label{fig:re5}
		\includegraphics[width=70mm]{Kap4/reglas5_2}}
...
Visualización de reglas de asociación para toda la base de datos utilizando el gen RB1 como filtro. 

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Kap4/RB1}
	\caption{Reglas de asociación sin variantes sinónimas} \label{fig:re7}
\end{figure}


Otro filtro que fue aplicado en el gen RB1 se presentan las 10 primeras reglas en la figura \label{fig:re7} con variantes tipo Stop gain, y no se encuentran reglas para variantes sinónimas o no sinónimas. Las reglas presentan variantes asociadas al género femenino, a dos grupos y a dos rangos de edad distintos unicamente. 


\section{Prototipo de visualización}

Finalmente se desarrollo un dashboard utilizando la herramienta R, para mostrar todos los resultados obtenidas en el presente trabajo, para que las variantes que fueron encontradas puedan ser consultadas por la comunidad académica y científica. Este aplicativo presenta una pestaña general que muestra, la distribución demográfica de la población, la distribución del tipo de variantes encontradas y la distribución de las variantes encontradas por rangos de edad. Posteriormente se muestra una pestaña con cada grupo, donde se muestran las reglas de asociación obtenidas, la frecuencia de palabras del grupo y los rangos de edad por genero del grupo. Finalmente se muestra las reglas de asociación para el gen CFTR  sin las variantes y para el RB1 sinónimas y una tabla final con las variantes anotadas se obtuvieron. La figura \ref{fig:dash} muestra un screenshot  del aplicativo de visualización desarrollado, en la que se muestra los análisis exploratorios de las variantes.
